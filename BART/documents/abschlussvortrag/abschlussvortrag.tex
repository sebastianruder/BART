...
\section{Evaluation}
\begin{frame}{Vergleich mit BART (Deutsch) und Stanford (Englisch)}
\begin{table}[h]
\begin{tabular}{l||ll|l}
               & \textbf{Recall}		 & \textbf{Precision} & \textbf{F\_1}    \\ \hline
Unser System 	& 0.496      & 0.630              & \textbf{0.555}  \\
BART  & 0.705 		 & 0.401     & \textbf{0.511}    \\ 
Stanford & 0.596   & 0.609      & \textbf{0.603}
          
\end{tabular}
\caption{MUC-Score unseres Systems, BART (SemEval-2010 Task 1) und  des Stanford-Systems (CoNLL 2011) im Vergleich} 
\end{table}
\end{frame}
...
SpeakerIdentification       & .05            & .360              & \textbf{.010}          	& .87    & .727      & \textbf{.155}  \\
+StringMatch      & .138           & .748              & \textbf{.232}          	& .295   & .718      & \textbf{.419}  \\
+RelaxedStringMatch         & .149           & .740              & .248         	& .297   & .712      & .419   \\
+PreciseConstructs & .200           & .759     & \textbf{.317}           	& .302   & .710      & \textbf{.423}  \\
+StrictHeadMatchA  & .282           & .714              & .404          	& .344   & .661      & .452  \\
+StrictHeadMatchB  & .334           & .672              & .446          	& .349   & .658      & .456   \\
+StrictHeadMatchC           & .344           & .661              & .453           	& .358   & .640       & .459 \\
+ProperHeadNounMatch        & .348           & .663     & .456            	& .362   & .635      & .461  \\
+RelaxedHeadMatch           & .371           & .669              & .478           	& .367   & .632      & .465   \\
+PronounMatch		    & .496           & .630              & \textbf{.555} 	& .596   & .609      & \textbf{.603}     
\end{tabular}
\end{table}
\end{frame}
...
\item Korpusunterschiede zwischen TüBa-D/Z und OntoNotes (bspw. keine \textit{singleton mentions} in OntoNotes, keine \textit{mentions} in Appositionalkonstruktionen in TüBa-D/Z)
