...
$S = \frac{s}{2^d}$ \\
Wir berechnen die \textit{salience} wie \citeasnoun{wunsch2006}, nur berücksichtigen wir keine Kataphern und keine Antezedenten die mehr als 3 Sätze entfernt sind. Außerdem verwenden wir nicht die Head Noun Emphasis, aber führen zusätzlich noch das proper noun Feature ein.  
\end{itemize}
