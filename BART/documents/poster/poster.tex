...
\begin{tikzfigure}[Comparison with BART Machine Learning Configuration (\texttt{XMLExperiment})]	
...
\begin{tikzfigure}[Performance of individual sieves]
\begin{tabular}{l||ll|l}
& \multicolumn{3}{c}{\textbf{MUC-Score}} \\ \hline
	                 & \textbf{Recall} & \textbf{Precision} & \textbf{F\_1} \\ \hline
...
\begin{tikzfigure}[Comparison with Stanford System (English)]
\begin{tabular}{l||ll|l}
...
\block{Not yet recognizable entities}{...} 
