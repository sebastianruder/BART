 ...
 * @author yannick
 */
public class AltCarafeMerger extends Merger {
            ...
            final Markable markable, final HashMap<String,String> attributes, final String type)
    {
       ...
       // attributes.put(TYPE_ATTRIBUTE, type);
        ...
        attributes.put(WIKI1_ATTRIBUTE,markable.getAttributeValue("wiki1"));
        attributes.put(WIKI2_ATTRIBUTE,markable.getAttributeValue("wiki2"));
//        attributes.put("min_ids",markable.getAttributeValue("min_ids"));
