 ...
 * @author kepa
 */
public class FE_DE_ModificatorMatch implements PairFeatureExtractor {
    ...
    public void extractFeatures(PairInstance inst) {
        inst.setFeature(FD_DE_MODIFSTRINGMATCH, getDEModificatorMatch(inst));
    }

    public boolean getDEModificatorMatch(PairInstance inst) {
