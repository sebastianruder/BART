...
//For the StrMatch
public class FE_DE_ShallowAttributeIncompatibility implements PairFeatureExtractor {

    public static final FeatureDescription<Boolean> FD_DE_SHALLOWATTRIBUTEINCOMPATIBILITY =
            new FeatureDescription<Boolean>(FeatureType.FT_BOOL, "DeShallowAtributeIncompatibility");

    public void describeFeatures(List<FeatureDescription> fds) {
        fds.add(FD_DE_SHALLOWATTRIBUTEINCOMPATIBILITY);
    }

    public void extractFeatures(PairInstance inst) {
        inst.setFeature(FD_DE_SHALLOWATTRIBUTEINCOMPATIBILITY, getDEShallowAttributeIncompatibility(inst));
    }
