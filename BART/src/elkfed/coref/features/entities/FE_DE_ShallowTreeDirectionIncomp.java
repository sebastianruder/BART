...
//For the StrMatch
public class FE_DE_ShallowTreeDirectionIncomp implements PairFeatureExtractor {

    public static final FeatureDescription<Boolean> FD_DE_SHALLOWTREEDIRECTIONGINCOMP =
            new FeatureDescription<Boolean>(FeatureType.FT_BOOL, "DeShallowTreeDirectionalIncomp");

    public void describeFeatures(List<FeatureDescription> fds) {
        fds.add(FD_DE_SHALLOWTREEDIRECTIONGINCOMP);
    }

    public void extractFeatures(PairInstance inst) {
        inst.setFeature(FD_DE_SHALLOWTREEDIRECTIONGINCOMP, getDEShallowTreeDirectionalIncomp(inst));
    }

    public boolean getDEShallowTreeDirectionalIncomp(PairInstance inst) {
