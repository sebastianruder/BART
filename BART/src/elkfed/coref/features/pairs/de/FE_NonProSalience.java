 ...
 * Semantically compatible is every markable that has a equal semantic
 * class or the semantic class UNKNOWN.
 *
 * The german implementation is only extended to take appositions into
 * account via the HeadMatcher.
 */
public class FE_NonProSalience extends HeadMatcher implements PairFeatureExtractor {
                    ...
                    if(!antecedent.getPronoun()) {
                        ...
                        for (Mention mention: this.mentions) {
                            ...
                            if(     !mention.getPronoun() &&
                                ...
                                if (getHeadMatch(antecedent, mention, new EndsWithMatcher())) {
                                    salience += 1;
                                }
    ...
    public class EndsWithMatcher extends BooleanMatcher {
