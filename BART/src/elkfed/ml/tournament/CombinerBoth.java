...
public class CombinerBoth implements FeatureExtractor {
    ...
    public void extractFeatures(Instance inst0) {
        ...
        for (int i=0; i<singleFeatures.size(); i++)
        {
            ...
            FeatureDescription f2=features2.get(i);
            Object o2=inst.inst2.getFeature(fd);
            if (o2!=null)
            {
                inst.setFeature(f2, o2);
            }
        }
    }
