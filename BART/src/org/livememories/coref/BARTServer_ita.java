...
/** runs BART's web demo/REST webservice for Italian
 * in an embedded Jetty web server
 * @author yannick
 */
public class BARTServer_ita {

    private boolean fake_var=true;
    ...
    public static void main(String[] args) {
        try {
            ...
            ShowText_ita servlet = new ShowText_ita();
            File bartRoot = ConfigProperties.getInstance().getRoot();

            MALTWrapper malt=new MALTWrapper("tut-all.mco");
            TabularImport ti;
